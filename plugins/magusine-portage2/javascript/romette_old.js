...
$(document).ready(function() {
  ...
  // var urlBandeau = $('#header_bandeau').css('background-image');
    // alert(urlBandeau);
  if ($('#header_bandeau').length != 0) {
    $('#header_bandeau').fadeTo(1500, 1).fadeOut(3000, function() {
      $('#header_bandeau').css('z-index', '-100');
      // $('#corps').fadeTo(200,1);
        // $('#contextes').fadeTo(200,1);
      });
    $('#bandeau-main').fadeTo(2000, 1).fadeOut(3000);
    // $('#corps').fadeTo(10,0).fadeTo(4000);

    /*
     * $('#corps').fadeTo(1,0); $('#contextes').fadeTo(1,0);
     */
  } else {
